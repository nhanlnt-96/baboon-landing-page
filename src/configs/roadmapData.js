export const roadmapData = [
  ...
  {
    percent: "40%",
    question: ["Why don't the Baboon in the jungle play poker anymore?...", " There are just too many cheetahs"],
  ...
  {
    percent: "50%",
    question: ["Wanna know why those Baboon are always drinking in the park?...", " It’s the only place with monkey" +
    " bars!"],
    answer: ["A Cool Cats NFT will be airdropped to a lucky Babbling Baboon owner with a estimated value of 8 Eth = $35,000 USD"]
  },
  {
    percent: "80%",
    question: ["Why do Baboon have big nostrils?...", " They have big fingers."],
